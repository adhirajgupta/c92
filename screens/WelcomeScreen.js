...
.then(() => {
  ...
  this.props.navigation.navigate('Teacher' , {navigator: AppTabNavigator.js}) 
  } else {
    this.props.navigation.navigate('Children') , {navigator: TabNavigator.js}
  } 
})
.catch((error) => {
  var errorCode = error.code;
...
<View style={styles.container}>
 ...
 <View style={{ justifyContent: 'center', alignItems: 'center' }}>
  ...
  <View style={{ justifyContent: 'center', alignItems: 'center' }}>
    <Text style={styles.title}>GARMENT APP</Text>
  </View>
  <View>
    <TextInput
